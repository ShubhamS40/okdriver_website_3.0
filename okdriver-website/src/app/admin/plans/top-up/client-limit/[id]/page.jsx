...
export default function ClientLimitPlanDetail({ params }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const payload = {
        ...
        clientCount: parseInt(editedPlan.clientLimit),
        ...
        <div className="p-6">
          ...
          {isEditing ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                <h3 className="text-sm font-medium text-gray-500">Client Limit</h3>
                <p className="mt-1">{plan.clientLimit} clients</p>
              </div>
