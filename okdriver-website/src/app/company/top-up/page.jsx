  ...
  const fetchPlans = async () => {
    ...
    try {
      const [vehicleResponse, clientResponse] = await Promise.all([
        fetch('http://localhost:5000/api/admin/company/top-up-plan/vehicle-limit/vehicle-limit-plans'),
        fetch('http://localhost:5000/api/admin/company/top-up-plan/client-limit/client-limit-plans')
      ]);
